...
<!-- BEGIN HORIZONTAL FORM -->
    <div class="row">
        <div class="col-lg-12">
            <form method="POST" action="{{ route('cobranca.cobranca.store') }}" accept-charset="UTF-8" id="create_cobranca_form" name="create_cobranca_form" class="form-horizontal">
                <div class="card">
                    ...
                    {{ csrf_field() }}
                    @include ('cobranca.form', [ 'cobranca' => null,   ])
