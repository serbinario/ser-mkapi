<div class="card-body">
    ...
    <div class="form-group {{ $errors->has('pool_id') ? 'has-error' : '' }}">
        <label for="pool_id" class="col-md-2 control-label">Pool</label>
        <div class="col-md-10">
    ...
    <div class="form-group {{ $errors->has('dns1_server') ? 'has-error' : '' }}">
        <label for="dns1_server" class="col-md-2 control-label">Dns1 Server</label>
        <div class="col-md-10">
            <input class="form-control" name="dns1_server" type="text" id="dns1_server" value="{{ old('dns1_server', isset($profile->dns1_server) ? $profile->dns1_server : null) }}" maxlength="20" placeholder="Enter dns1 server here...">
            {!! $errors->first('dns1_server', '<p class="help-block">:message</p>') !!}
        </div>
    </div>

    <div class="form-group {{ $errors->has('dns2_server') ? 'has-error' : '' }}">
        <label for="dns2_server" class="col-md-2 control-label">Dns2 Server</label>
        <div class="col-md-10">
            <input class="form-control" name="dns2_server" type="text" id="dns2_server" value="{{ old('dns2_server', isset($profile->dns2_server) ? $profile->dns2_server : null) }}" maxlength="20" placeholder="Enter dns2 server here...">
            {!! $errors->first('dns2_server', '<p class="help-block">:message</p>') !!}
        </div>
    </div>

    <div class="form-group {{ $errors->has('rate_limit_tx_tx') ? 'has-error' : '' }}">
        <label for="rate_limit_tx_tx" class="col-md-2 control-label">Rate Limit Tx Tx</label>
        <div class="col-md-10">
            <input class="form-control" name="rate_limit_tx_tx" type="text" id="rate_limit_tx_tx" value="{{ old('rate_limit_tx_tx', isset($profile->rate_limit_tx_tx) ? $profile->rate_limit_tx_tx : null) }}" maxlength="50" placeholder="Enter rate limit tx tx here...">
