<div class="card-body">
    ...
    <div class="row">
        <div class="col-sm-6">
            <div class="form-group {{ $errors->has('login') ? 'has-error' : '' }}">
                ...
                <div class="col-md-8">
                    <input class="form-control input-sm" name="nome" type="text" id="nome" value="{{ old('nome', isset($cliente->nome) ? $cliente->nome : null) }}" minlength="1" maxlength="255" required="true" placeholder="Enter nome here...">
    ...
    <div class="form-group juridico {{ $errors->has('cnpj') ? 'has-error' : '' }}">
        ...
        <div class="col-md-10">
            <input class="form-control input-sm" name="cnpj" type="text" id="cnpj" value="{{ old('cnpj', isset($cliente->clienteable->cnpj) ? $cliente->clienteable->cnpj : null) }}"   placeholder="Entre com o CPF...">
    ...
    <div class="form-group {{ $errors->has('router_id') ? 'has-error' : '' }}">
        ...
        <div class="col-md-10">
            ...
            {!! $errors->first('router_id', '<p class="help-block">:message</p>') !!}
        </div>
    </div>
    ...
    <div class="form-group {{ $errors->has('vencimento_dia_id') ? 'has-error' : '' }}">
        ...
        <div class="col-md-10">
            ...
            {!! $errors->first('vencimento_dia_id', '<p class="help-block">:message</p>') !!}
        </div>
    </div>
    ...
    <div class="form-group {{ $errors->has('dias_bloqueio') ? 'has-error' : '' }}">
        ...
        <div class="col-md-10">
            ...
            {!! $errors->first('dias_bloqueio', '<p class="help-block">:message</p>') !!}
        </div>
    </div>
    ...
    <div class="form-group {{ $errors->has('dias_msg_pendencia') ? 'has-error' : '' }}">
        ...
        <div class="col-md-10">
            ...
            {!! $errors->first('dias_msg_pendencia', '<p class="help-block">:message</p>') !!}
        </div>
    </div>
